...
public class InventoryInnerDetailActivity extends BaseActivity {
    ...
    private void initHead(){
        if(productEntity!=null){
            ...
            tv_productcode.setText(detail.getProduct_code());
            TextView tv_customscode=(TextView)view.findViewById(R.id.tv_inner_customscode);
            tv_customscode.setText(detail.getExternal_no());
            ...
            tv_capacity.setText(detail.getLength()+"*"+detail.getWidth()+"*"+detail.getHeight());
