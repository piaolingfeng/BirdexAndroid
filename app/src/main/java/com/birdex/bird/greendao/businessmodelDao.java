...
/** 
 * DAO for table "BUSINESSMODEL".
*/
public class businessmodelDao extends AbstractDao<businessmodel, Void> {

    public static final String TABLENAME = "BUSINESSMODEL";

    /**
     * Properties of entity businessmodel.<br/>
    ...
    */
    ...
    public businessmodelDao(DaoConfig config) {
        super(config);
    }
    
    public businessmodelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BUSINESSMODEL\" (" + //
                "\"ID\" TEXT," + // 0: id
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BUSINESSMODEL\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, businessmodel entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public businessmodel readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, businessmodel entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(businessmodel entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(businessmodel entity) {
        return null;
    }
