 ...
 * DAO for table "TAPE".
*/
public class tapeDao extends AbstractDao<tape, Void> {

    public static final String TABLENAME = "TAPE";

    /**
     * Properties of entity tape.<br/>
    ...
    */
    ...
    public tapeDao(DaoConfig config) {
        super(config);
    }
    
    public tapeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TAPE\" (" + //
                "\"ID\" TEXT," + // 0: id
                "\"TYPE\" TEXT," + // 1: type
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TAPE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, tape entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public tape readEntity(Cursor cursor, int offset) {
        tape entity = new tape( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, tape entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(tape entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(tape entity) {
        return null;
    }
